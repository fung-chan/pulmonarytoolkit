classdef MYOutputLungDensityAverage5x5x5 < PTKPlugin
    % MYOutputLungDensityAverage5x5x5. Plugin for outputing the lung density result 
    % averaged over a 5x5x5 voxel neighborhood and saved as exdata format
    %
    ...
    properties
        ButtonText = 'Output Lung Density Average (5x5x5)'
        ToolTip = 'Output Lung segmentation data cloud with density information averaged over a 5x5x5 neighborhood and convert it into exdata and ipdata'
        Category = 'Export'
    ...
    methods (Static)
        function results=RunPlugin(dataset,reporting)
              ...
              for j=3:n:a1-1
                  for k=3:n:b1-1
                      if Lung(j,k,i)==2
                          ...
                          HU_value = lungs.GrayscaleToRescaled(Raw(j-2:j+2,k-2:k+2,i-2:i+2));
          ...
          save_full_path=fullfile(save_root_path,'PTKLungDensity5x5x5');
