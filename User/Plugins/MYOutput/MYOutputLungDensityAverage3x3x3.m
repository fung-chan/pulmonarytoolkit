classdef MYOutputLungDensityAverage3x3x3 < PTKPlugin
    % MYOutputLungDensityAverage3x3x3. Plugin for outputing the lung density result 
    % averaged over a 3x3x3 voxel neighborhood and saved as exdata format
    %
    ...
    methods (Static)
        function results=RunPlugin(dataset,reporting)
          ...
          save_full_path=fullfile(save_root_path,'PTKLungDensity3x3x3');
