...
%                                 density_value = HU_value;
           ...
           offset = 0;
            MYExportField('LungDensity_Lefttrimmed.exdata',LeftLungCoor,Left_density_value,'Density_Left',offset,save_full_path);
            MYFieldIpdata('LungDensity_Lefttrimmed.ipdata',LeftLungCoor,Left_density_value,'Density_Left',offset,save_full_path);
           offset = offset + length(LeftLungCoor) + 10;
